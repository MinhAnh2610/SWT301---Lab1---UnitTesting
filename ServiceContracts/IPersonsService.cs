...
namespace ServiceContracts
{
    public interface IPersonsService
    {
        ...
        /// </summary>
        /// <param name="personAddRequest">Person
        /// to add</param>
        /// <returns>
        /// returns the same person details, along
        /// with the newly generated PersonID</returns>
        ...
        /// Returns all persons
        /// </summary>
        /// <returns>Returns a list of objects of
        /// PersonResponse type</returns>
        ...
        List<PersonResponse> GetFilteredPersons
            (string searchBy, string? searchString);

        /// <summary>
        /// Returns sorted list persons
        /// </summary>
